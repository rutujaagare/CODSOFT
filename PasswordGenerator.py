...
def password_generate():
    try:
        ...
        messagebox.askretrycancel("A Problem Has Been occures", "Please Try Again")
...
title.pack(anchor="center", pady=30)
...
generate_btn.pack(anchor="center", pady=60)
